...
exports.register_guardian = async function(req, res, next) {
    ...
    if (rows.length > 0) {
        ...
        db.query("INSERT INTO student (email,password,FName,LName,P_Num) VALUES (?,?,?,?,?);", [email, password, FName, LName, phone_Num]);
        //response_conf = "Guardian registered successfully";
